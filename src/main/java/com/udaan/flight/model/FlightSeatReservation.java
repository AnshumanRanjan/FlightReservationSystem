...
import com.udaan.flight.repository.FlightDetailRepository;
...
public class FlightSeatReservation {
	...
	public FlightSeatReservation(long flightNumber, Date flightDate , UserSelection userSel , FlightDetailRepository flightDetailRepository) {
	...
	public Boolean researveSeats(List<String> seatNumber ,FlightDetailRepository flightDetailRepository  ) {
		...
		// CHeck if the number of available seats are not less than number of seats asked in the list :TODO
