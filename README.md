...
> Please design airplane seating chart system. 
  
 The program will initially start with an empty airplane.  
 The system will ask seating preferences (such as window, isle seat, section of the plane) as well as how many tickets.   
 Based on availability and seating preferences, the program will choose the seats, display a diagram and the coordinates.   
The system should also allow for a customer pick a specific seat.   
Assume that the middle 3 rows in section 2 are wing seats.   
